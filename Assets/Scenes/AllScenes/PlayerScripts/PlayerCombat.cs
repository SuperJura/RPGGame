...
public class PlayerCombat : MonoBehaviour {
    ...
    public event OnAbilityFiredHandler OnAbiliyFired;   //Za GUI (Da se pokaze da je Ability bio stisnut)

    public delegate void OnAbilityCooldownHandler(float cooldown, int index);   //cooldown je izmedu 0 i 1 ( 1 znaci da se moze opet iskoristiti)
